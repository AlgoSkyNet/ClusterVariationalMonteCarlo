...
${OBJECTDIR}/src/main.o: src/main.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/opt/gmp-5.0.2/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp
...
${OBJECTDIR}/src/main_nomain.o: ${OBJECTDIR}/src/main.o src/main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -I/opt/gmp-5.0.2/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main_nomain.o src/main.cpp;\
	else  \
