...
LDLIBSOPTIONS=-L/opt/gmp-5.0.2/lib -lgmp -lgmpxx
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/clustervariationalmontecarloperf7: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/clustervariationalmontecarloperf7 ${OBJECTFILES} ${LDLIBSOPTIONS} -fopemp

${OBJECTDIR}/src/newmain.o: src/newmain.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/opt/gmp-5.0.2/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/newmain.o src/newmain.cpp
...
${TESTDIR}/tests/newsimpletest.o: tests/newsimpletest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newsimpletest.o tests/newsimpletest.c
...
${OBJECTDIR}/src/newmain_nomain.o: ${OBJECTDIR}/src/newmain.o src/newmain.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/opt/gmp-5.0.2/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/newmain_nomain.o src/newmain.cpp;\
	else  \
