...
${OBJECTDIR}/newmain.o: newmain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/opt/gmp-5.0.2/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/newmain.o newmain.cpp
...
${OBJECTDIR}/newmain_nomain.o: ${OBJECTDIR}/newmain.o newmain.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/opt/gmp-5.0.2/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/newmain_nomain.o newmain.cpp;\
	else  \
