...
#define	MCMEASUREMENTDOUBLEOCCUPATION_H

class mcMeasurementDoubleOccupation : public mcAbstractMeasurement {
public:
    
    mcMeasurementDoubleOccupation(){
    }
    mcMeasurementDoubleOccupation(mcConfiguration* conf, mcAbstractVector* twf) {
...
#endif	/* MCMEASUREMENTDOUBLEOCCUPATION_H */
